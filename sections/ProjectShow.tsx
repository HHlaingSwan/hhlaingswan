...
const ProjectShow = () => {
	return (
		<section
			id='projects'
			className='py-20 bg-background [perspective:1200px] bg-[repeating-linear-gradient(45deg,var(--muted)_0,var(--muted)_0.5px,transparent_0,transparent_20px)]'>
				...
				<motion.div
					...
					{projects.map((project, index) => {
						...
						return (
							<motion.div
								key={project.title}
								className={`bg-card  rounded-xl overflow-hidden shadow-lg flex flex-col transition-all duration-300 hover:shadow-primary/20 hover:border-primary/30 hover:-translate-y-2 [transform-style:preserve-3d] ${spanClass}`}
